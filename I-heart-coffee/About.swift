...
//                .padding(55)
            ...
            Text("This app uses a customized calculation of 6.4 grams per tablespoon. I have measured this myself personally and this is the estimation I use for all my calculations in this app. Weight is measured AFTER coffee beans have been grinded.")
                .padding()
